...
public class BichoMayor extends Ser{
    ...
    BichoMayor() {
        ...
        Vacio colision = new Vacio(anchura-(anchura*0),altura-(altura*.3));
        colision.asignarX(x + (obtenerAnchura()/3)*2);
        colision.asignarY(y + colision.obtenerAltura()/2);
